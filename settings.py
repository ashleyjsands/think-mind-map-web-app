...
from utilities import addIpaddrToPythonPath

addIpaddrToPythonPath()
...
# folllowing line modified by Ashley Sands
DATABASE_ENGINE = 'appengine' #appengine # 'postgresql_psycopg2', 'postgresql', 'mysql', 'sqlite3' or 'oracle'.
...
# Added to fix an app bug.
SETTINGS_MODULE = 'think-app.settings'
